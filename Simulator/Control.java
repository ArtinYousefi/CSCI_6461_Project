...
public class Control {
    ...
    public void stepSimulator() {
        ...
        switch (op) {
            ...
            case "010010": 
            	...
            	break;
            case "010011":	//JMA (Unconditional Jump to Address)  
            	mem.PC = ea;
	        jumped = true;
            	break;
    ...
    public static void jsr(byte ix, byte addr, byte indirect) {
	...
	private static void mlt(byte rx, byte ry) {
    ...
    //bit shifting operations/instructions
