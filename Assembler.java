...
public class Assembler {
    ...
    private static void passTwo(String fileName, String listingFile, String loadFile) throws IOException {
        ...
        while ((line = reader.readLine()) != null) {
            ...
            if (parts[0].equalsIgnoreCase("Data")) {
                ...
                if (opcode.equals("100001")) { //LDX
                	binaryCode = opcode + parseOperandsQF(operands);
                }else {
                	binaryCode = opcode + parseOperands(operands);
                }
    ...
    // Converts operands to their binary representation QUICKFIX for LDX 
    private static String parseOperandsQF(String operands) {
        if (operands.isEmpty()) return "0000000000"; // Default empty operands
