...
//        int addr = Integer.parseInt(binary.substring(11, 16), 2);
        ...
        switch (op) {
            ...
            case "010001": //JNE (Jump If Not Equal)
                ...
                break;
            case "010010": //JCC NOT IMPLEMENTED YET
            	System.out.println("DID NOT IMPLEMENT JCC YET");
            	break;
            ...
            case "010100":	//JSR (Jump and Save Return Address)  
            	System.out.println("DID NOT IMPLEMENT JSR YET");
            	break;
            ...
            case "010110":	//SOB (Subtract One and Branch)  
            	System.out.println("DID NOT IMPLEMENT SOB YET");
            	break;
            ...
            case "110001":	//IN (Input Character to Register From Device)  
            	System.out.println("DID NOT IMPLEMENT IN YET");
            	break;		
            case "110010":	//OUT (Output Character to Device From Register)  
            	System.out.println("DID NOT IMPLEMENT OUT YET");
            	break;		
...
//will move these below once they're all done
	...
	private void air(int r, int immed) { //need to add MBR stuff here
		if(immed == 0) {
			return; //do nothing
		}
	...
	private void mvt(int rx, int ry) {
	...
	private void trr(int rx, int ry) { //this sets the condition code in memory could either convert it to binary and set the bit
    ...
    private void src(int r, int count, int al, int lr) {
    	int tbs = mem.GPR[r];
    ...
    private void rrc(int r, int count, int al, int lr) { //need to use MAR and MBR too UPDATE THIS
        int s=16;
        int tbr = mem.GPR[r];
