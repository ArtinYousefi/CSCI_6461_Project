...
public class Assembler {
    ...
    public static void main(String[] args) {
        ...
        // String assemblyFile = "src\\sourceall.txt";
    ...
    //parsing operands for the different sets as listed at the top of the file. Based on encoding + inputs
...
//FROM HERE ONWARDS, THE ENCODING IS DIFF SO NEED TO UPDATE!
